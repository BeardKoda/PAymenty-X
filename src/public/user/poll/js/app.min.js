!(function(e, t) {
    ...
    function A(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Pe.hasData(e) &&
                ((a = Pe.access(e)), (l = pe.extend({}, a)), Pe.set(t, l));
        }
    }
    function D(e, t) {
    ...
    function N(e, t, i, r) {
        ...
        if (
            m ||
            (d > 1 && "string" == typeof p && !de.checkClone && tt.test(p))
        )
        ...
        if (
            ...
            if (l)
                for (
                    u = a[a.length - 1].ownerDocument, pe.map(a, j), f = 0;
                    f < l;
                    f++
                )
                    (c = a[f]),
                    ...
                    for (t in e)
                        (n = s[t]),
                            ...
                            s !== i &&
                                (c &&
                                i &&
                                (pe.isPlainObject(i) || (r = Array.isArray(i)))
                                    ? (r
                                          ? ((r = !1),
                                            (o =
                                                n && Array.isArray(n) ? n : []))
                                          : (o =
                                                n && pe.isPlainObject(n)
                                                    ? n
                                                    : {}),
                                      (s[t] = pe.extend(c, o, i)))
                                    : void 0 !== i && (s[t] = i));
    ...
    var be = (function(e) {
        function t(e, t, n, i) {
            ...
            if (
                !i &&
                ((t ? t.ownerDocument || t : M) !== k && N(t), (t = t || k), I)
            ) {
                if (11 !== p && (l = me.exec(e)))
                    if ((r = l[1])) {
                        if (9 === p) {
        ...
        function v(e) {
            for (
                ...
                if ((n = _.relative[e[a].type])) u = [d(h(u), n)];
                    ...
                    if (
                        (n = _.filter[e[a].type].apply(null, e[a].matches))[R]
                    ) {
            ...
            (N = t.setDocument = function(e) {
                ...
                return i !== k && 9 === i.nodeType && i.documentElement
                    ? ((k = i),
                      ...
                      (P = []),
                      (L = []),
                      (w.qsa = pe.test(k.querySelectorAll)) &&
                          (r(function(e) {
                          ...
                          ? function(e, t) {
                                ...
                                return (
                                    ...
                                    (!w.sortDetached &&
                                        ...
                                        ? e === k ||
                                          (e.ownerDocument === M && H(M, e))
                                            ? -1
                                            : t === k ||
                                              (t.ownerDocument === M && H(M, t))
                                            ? 1
                                            : A
                                            ? J(A, e) - J(A, t)
                                            : 0
            ...
            (S = t.select = function(e, t, n, i) {
                ...
                if (((n = n || []), 1 === d.length)) {
                    if (
                        ...
                        if (
                            !(t = (_.find.ID(s.matches[0].replace(ve, ye), t) ||
                                [])[0])
                        )
                            return n;
                        u && (t = t.parentNode),
    ...
    (pe.filter = function(e, t, n) {
        ...
        pe.fn.extend({
            ...
            is: function(e) {
                return !!o(
                    this,
                    "string" == typeof e && Ee.test(e) ? pe(e) : e || [],
                    !1
                ).length;
            }
        });
                            ...
                            return pe
                                .Deferred(function(e) {
                                    n[0][3].add(
                                        ...
                                        n[1][3].add(
                                            o(0, e, pe.isFunction(t) ? t : l)
                                        ),
                                        n[2][3].add(
                                            o(0, e, pe.isFunction(i) ? i : c)
                                        );
                                })
                                .promise();
                        },
                            ...
                            (u = pe.extend(
                                {
                                    ...
                                    selector: r,
                                    needsContext:
                                        r && pe.expr.match.needsContext.test(r),
                                    namespace: p.join(".")
                                },
                                o
                            )),
    ...
    pe.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (
                ...
                for (s = y(a), o = y(e), i = 0, r = o.length; i < r; i++)
                    D(o[i], s[i]);
            if (t)
                if (n)
                    for (
                        o = o || y(e), s = s || y(a), i = 0, r = o.length;
                        i < r;
                        i++
                    )
                        A(o[i], s[i]);
        ...
        cleanData: function(e) {
            for (
                var t, n, i, r = pe.event.special, o = 0;
                void 0 !== (n = e[o]);
                o++
            )
                if (Ie(n)) {
        ...
        pe.each(
            ...
            function(e, t) {
                pe.fn[e] = function(e) {
                    for (
                        var n, i = [], r = pe(e), o = r.length - 1, s = 0;
                        s <= o;
                        s++
                    )
                    ...
                    var r,
                        ...
                        s =
                            ...
                            H(
                                ...
                                t,
                                i,
                                "border-box" === pe.css(e, "boxSizing", !1, o),
                                o
                            );
                    return (
                        s &&
                ...
                select: {
                    ...
                    set: function(e, t) {
                        for (
                            ...
                            (i = r[s]),
                                (i.selected =
                                    pe.inArray(pe.valHooks.option.get(i), o) >
                                    -1) && (n = !0);
            ...
            if (
                ...
                for (o = 0; (s = d[o++]) && !t.isPropagationStopped(); )
                    (t.type = o > 1 ? l : f.bindType || h),
                        (u =
                            (Le.get(s, "events") || {})[t.type] &&
                            Le.get(s, "handle")) && u.apply(s, n),
                        (u = c && s[c]) &&
                            u.apply &&
                            Ie(s) &&
            ...
            ajax: function(t, n) {
                ...
                (f = pe.event && p.global) &&
                    ...
                    p.ifModified &&
                        ...
                        pe.etag[o] &&
                            x.setRequestHeader("If-None-Match", pe.etag[o])),
                        ...
                        "fixed" === pe.css(n, "position")
                            ...
                            : ((e = this.offsetParent()),
                              ...
                              (i = {
                                  top:
                                      i.top +
                                      pe.css(e[0], "borderTopWidth", !0),
                                  left:
                                      i.left +
                                      pe.css(e[0], "borderLeftWidth", !0)
                              })),
                        {
    ...
    (function(e, t) {
        ...
        function j(t, n, i) {
            return (
                (void 0 === i ? t : t.slice(0, S(t, "name", i))).forEach(
                    function(t) {
                        t.function &&
                            console.warn(
                    ...
                    arrow: {
                        ...
                        fn: function(e, n) {
                            ...
                            var r = e.placement.split("-")[0],
                                ...
                                m = E(i)[c];
                            a[p] - m < s[f] &&
                                (e.offsets.popper[f] -= s[f] - (a[p] - m)),
                                a[f] + m > s[p] &&
                                    (e.offsets.popper[f] += a[f] + m - s[p]);
                            var g = a[f] + a[c] / 2 - m / 2,
                                v = t(e.instance.popper, "margin" + u).replace(
                                    "px",
                                    ""
                                ),
                            ...
                            if (
                                ((l =
                                    "bottom" == h
                                        ...
                                        : d.top),
                                (a =
                                    "right" == m ? -u.width + d.right : d.left),
                                c && g)
                            )
                                (f[g] =
                ...
                return (
                            ...
                            t(
                                ...
                                this._pointerEvent
                                    ? (t(this._element).on(
                                      ...
                                      t(this._element).on(L.POINTERUP, function(
                                          e
                                      ) {
                                          return i(e);
                                      }),
                                    ...
                                    : (t(this._element).on(
                                      ...
                                      t(this._element).on(L.TOUCHMOVE, function(
                                          t
                                      ) {
                                          var n;
                    ...
                    (e._jQueryInterface = function(n) {
                        return this.each(function() {
                            ...
                            if (
                                (i ||
                                    ((i = new e(this, r)), t(this).data(S, i)),
                                "number" == typeof n)
                            )
                                i.to(n);
        ...
        var pe = "modal",
            ...
            je = (function() {
                ...
                return (
                    ...
                    (n._getConfig = function(e) {
                        return (
                            (e = o({}, ye, e)), l.typeCheckConfig(pe, e, be), e
                        );
                    }),
                    (n._showElement = function(e) {
                        ...
                        var r = t.Event(we.SHOWN, { relatedTarget: e }),
                            o = function() {
                    ...
                    (n._setEscapeEvent = function() {
                        ...
                        this._isShown && this._config.keyboard
                            ? t(this._element).on(we.KEYDOWN_DISMISS, function(
                                  t
                              ) {
                                  27 === t.which &&
                            ...
                            : this._isShown ||
                              t(this._element).off(we.KEYDOWN_DISMISS);
                    }),
                    ...
                    (n._showBackdrop = function(e) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            if (
                                ...
                                t(this._element).on(we.CLICK_DISMISS, function(
                                    e
                                ) {
                    ...
                    (e._jQueryInterface = function(n, i) {
                        return this.each(function() {
                            ...
                            if (
                                (r ||
                                    ((r = new e(this, s)), t(this).data(me, r)),
                                "string" == typeof n)
                            ) {
                                if (void 0 === r[n])
                                    throw new TypeError(
                    ...
                    (e._jQueryInterface = function(n) {
                        return this.each(function() {
                            ...
                            if (
                                ...
                                (i ||
                                    ((i = new e(this, r)), t(this).data(Ie, i)),
                                "string" == typeof n)
                            ) {
                                if (void 0 === i[n])
                                    throw new TypeError(
                    ...
                    (n.show = function() {
                        ...
                        if (
                            ...
                            var a = t.Event(Et.HIDE, {
                                ...
                                c = t.Event(Et.SHOW, { relatedTarget: i });
                            if (
                                (i && t(i).trigger(a),
    ...
    function() {
        ...
        for (
            w = {
                ...
                s = (function() {
                    ...
                    return (
                        ...
                        (e.prototype.off = function(e, t) {
                            ...
                            if (
                                null !=
                                (null != (i = this.bindings) ? i[e] : void 0)
                            ) {
                                if (null == t) return delete this.bindings[e];
                                for (
                                    n = 0, r = [];
                                    n < this.bindings[e].length;
                ...
                U = 0,
                Q = ($ = ["ajax", "document", "eventLag", "elements"]).length;
            Q > U;
            U++
        )
            (q = $[U]), !0 === D[q] && (D[q] = w[q]);
        (l = (function(e) {
            ...
            (T = function() {
                ...
                return (
                    ...
                    L(s)
                        ? void 0
                        : c.running ||
                          (!1 === D.restartOnRequestAfter && "force" !== P(o))
                        ? void 0
                        : ((i = arguments),
                          "boolean" ==
                              typeof (n = D.restartOnRequestAfter || 0) &&
                              (n = 0),
                          setTimeout(function() {
                              var t, n, s, a, l;
                              if (
            ...
            (n = (function() {
                function e() {
                    var e,
                        ...
                        n = this;
                    (this.progress =
                        null != (t = this.states[document.readyState])
                            ? t
                            : 100),
                    ...
                    (this.progress = 0),
                        ...
                        (t = setInterval(function() {
                            ...
                            return (
                                ...
                                (e = g(r)),
                                ++i >= D.eventLag.minSamples &&
                                e < D.eventLag.lagThreshold
            ...
            (d = (function() {
                function e(e) {
                    (this.source = e),
                        ...
                        null != this.source &&
                            (this.progress = k(this.source, "progress"));
                }
                return (
                    (e.prototype.tick = function(e, t) {
                        var n;
                        return (
                            null == t && (t = k(this.source, "progress")),
                            t >= 100 && (this.done = !0),
                            t === this.last
            ...
            (j = function() {
                ...
                for (
                    c.sources = H = [],
                        n = 0,
                        r = (s = ["ajax", "elements", "document", "eventLag"])
                            .length;
                    r > n;
                    n++
                )
                    (e = s[n]), !1 !== D[e] && H.push(new f[e](D[e]));
                for (
                    i = 0,
                        o = (l = null != (a = D.extraSources) ? a : []).length;
                    o > i;
                    i++
                )
                    (q = l[i]), H.push(new q(D));
                            ...
                            (p.prototype = {
                                ...
                                afterAllSwitches: function() {
                                    ...
                                    e &&
                                        ...
                                        e.focus(),
                                        this.options.selectors.forEach(function(
                                            e
                                        ) {
                                            r(
                                    ...
                                    a
                                        ...
                                        : (t.preventDefault(),
                                          "multipart/form-data" === e.enctype
                                              ? (n.requestOptions.formData = new FormData(
                                                    e
                                                ))
                                              : (n.requestOptions.requestParams = i(
                                                    e
                                                )),
                                          e.setAttribute(
                                              "data-pjax-state",
...
var MODULE_CONFIG = {
        user: [
            "../assets/libs/list/list.js",
            "../assets/libs/notie/notie.min.js",
            "../assets/libs/notie/notie.js",
...
!(function(e, t) {
    ...
    (function($, MODULE_CONFIG, MODULE_OPTION_CONFIG) {
        ...
        $.fn.plugin = function() {
            return this.each(function() {
                var self = $(this),
                    opts =
                        self.attr("data-option") ||
                        self.attr("data-plugin-option"),
    ...
    (function(e) {
        ...
        function t() {
            var t = e(".setting");
            e("body")
                .removeClass(e("body").attr("ui-class"))
                ...
                app.setting.container
                    ? e("body").addClass("container")
                    : e("body").removeClass("container"),
                e("#aside, #aside .sidenav")
                    .removeClass(e("#aside .sidenav").attr("ui-class"))
                    .addClass(app.setting.aside)
                    .attr("ui-class", app.setting.aside),
                e("#aside .navbar")
                    .removeClass(e("#aside .navbar").attr("ui-class"))
                    .addClass(app.setting.brand)
                    .attr("ui-class", app.setting.brand),
                app.setting.fixedContent
                    ? e("body").addClass("fixed-content")
                    : e("body").removeClass("fixed-content"),
                app.setting.fixedAside
                    ? e("body").addClass("fixed-aside")
                    : e("body").removeClass("fixed-aside"),
                t
                    .find('input[name="folded"]')
                    .prop("checked", app.setting.folded),
                t
                    .find('input[name="fixedContent"]')
                    .prop("checked", app.setting.fixedContent),
                t
                    .find('input[name="fixedAside"]')
                    .prop("checked", app.setting.fixedAside),
                t
                    .find('input[name="container"]')
                    .prop("checked", app.setting.container),
                t.find('input[name="ajax"]').prop("checked", app.setting.ajax),
                t
                    .find(
                        'input[name="theme"][value="' + app.setting.theme + '"]'
                    )
                    .prop("checked", !0),
                t
                    .find('input[name="bg"][value="' + app.setting.bg + '"]')
                    .prop("checked", !0),
                t
                    .find(
                        'input[name="aside"][value="' + app.setting.aside + '"]'
                    )
                    .prop("checked", !0),
                t
                    .find(
                        'input[name="brand"][value="' + app.setting.brand + '"]'
                    )
                    .prop("checked", !0),
                i != app.setting.theme &&
                    lazyload
                        .load(
                            "../assets/css/" + app.setting.theme + ".css"
                        )
                        .then(function() {
                            lazyload.unload(
                                "../assets/css/theme/" + i + ".css"
                            ),
                                (i = app.setting.theme);
                        });
        }
        ...
        var i,
            r = app.color.primary + "-setting";
        n(r) ? (app.setting = n(r)) : n(r, app.setting);
        for (
            var o = window.location.search.substring(1).split("&"), s = 0;
            s < o.length;
            s++
        ) {
            var a = o[s].split("=");
            (app.setting[a[0]] =
                "true" == a[1] || "false" == a[1] ? "true" == a[1] : a[1]),
                n(r, app.setting);
        }
        e(document).on("click.setting", ".setting input", function(i) {
            var o = e(this),
                s = o.attr("name");
            (app.setting[s] = o.is(":checkbox")
                ? o.prop("checked")
                : e(this).val()),
                n(r, app.setting),
                t(app.setting),
    ...
    (function(e) {
        ...
        if (
            ...
            var t = {
                    classNames: {
                        remove:
                            "animate animate-reverse animate-fast animate-no-delay",
                        add: "animate",
                ...
                n = new Pjax({
                    cacheBust: !1,
                    elements:
                        "#aside a:not(.no-ajax), #content-header a, #nav a, .app-header a",
                    selectors: [
                        "title",
                        "#content-header",
                        "#content-footer",
...
!(function(e, t) {
    ...
    /iPhone|iPod|iPad|Silk|Android|BlackBerry|Opera Mini|IEMobile/.test(n) &&
